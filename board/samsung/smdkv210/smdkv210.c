...
#else	/* CONFIG_SPL_BUILD (add by hwq) */
...
{	
	...
	/* 2.è®¾ç½®PLLçš„PMSå€¼(ä½¿ç”¨èŠ¯ç‰‡æ‰‹å†Œæ¨èçš„å€¼)ï¼Œå¹¶ä½¿èƒ½PLL */
	/*	 	P	  	    M   		  S		     EN	*/
	...
	/* 
	** 4.è®¾ç½®ç³»ç»Ÿæ—¶é’Ÿæºï¼Œé€‰æ‹©PLLä¸ºæ—¶é’Ÿè¾“å‡º */
	...
	*/
	...
	/* 4.è®¾ç½®å…¶ä»–æ¨¡å—çš„æ—¶é’Ÿæº */

	/* 6.è®¾ç½®ç³»ç»Ÿæ—¶é’Ÿåˆ†é¢‘å€¼ */
