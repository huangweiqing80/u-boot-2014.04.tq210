...
/* input clock of PLL: SMDKV210 has 24MHz input clock(add by hwq) */
#define CONFIG_SYS_CLK_FREQ_V210	24000000

/* DRAM Base */
#define CONFIG_SYS_SDRAM_BASE		0x20000000	/* modied by hwq */

/* Text Base */
#define CONFIG_SYS_TEXT_BASE		0x20000000	/* modied by hwq */
...
#define CONFIG_SYS_PROMPT		"SMDKV210 # "	/* modied by hwq */
...
#define PHYS_SDRAM_1_SIZE	(1024 << 20)	/* 0x40000000, 1024 MB Bank #1 (modied by hwq) */
...
#define CONFIG_IDENT_STRING		" for SMDKV210"	/* modied by hwq */
...
#define CONFIG_SYS_INIT_SP_ADDR	(CONFIG_SYS_SDRAM_BASE + PHYS_SDRAM_1_SIZE)	/* modied by hwq */
